...
import {
  ...
  ICookies,
  IRequestWithCookies,
  TRegistrationRequestBody,
} from "../common/types"

class AuthController {
  async registration(
    req: Request<{}, void, TRegistrationRequestBody>,
    res: Response,
    next: NextFunction
  ) {
    try {
  ...
  async login(
    req: Request<
      {},
      void,
      Pick<TRegistrationRequestBody, "email" | "password">
    >,
    res: Response,
    next: NextFunction
  ) {
  ...
  async changePassword(
    req: IRequestWithCookies<{}, void, IChangePasswordRequestBody>,
    res: Response,
    next: NextFunction
  ) {
    try {
  ...
  async sendActivate(
    req: Request<{}, void, Pick<TRegistrationRequestBody, "email">>,
    res: Response,
    next: NextFunction
  ) {
    try {
